<!-- GENERATED by `cargo xtask deltas` from commit `b6ef4ee-dirty`. Do not edit by hand: the next run overwrites it. -->

# Delta marker index

> **This page is generated.** `cargo xtask deltas` wrote it from commit `b6ef4ee-dirty`.
