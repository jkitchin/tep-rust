<!-- GENERATED by `cargo xtask deltas` from commit `03ec3d6-dirty`. Do not edit by hand: the next run overwrites it. -->

# Delta marker index

> **This page is generated.** `cargo xtask deltas` wrote it from commit `03ec3d6-dirty`.
