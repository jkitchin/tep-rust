<!-- GENERATED by `cargo xtask deltas` from commit `2c27f7a-dirty`. Do not edit by hand: the next run overwrites it. -->

# Delta marker index

> **This page is generated.** `cargo xtask deltas` wrote it from commit `2c27f7a-dirty`.
