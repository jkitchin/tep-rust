<!-- GENERATED by `cargo xtask deltas` from commit `57cd18c`. Do not edit by hand: the next run overwrites it. -->

# Delta marker index

> **This page is generated.** `cargo xtask deltas` wrote it from commit `57cd18c`.
