<!-- GENERATED by `cargo xtask deltas` from commit `dc78185`. Do not edit by hand: the next run overwrites it. -->

# Delta marker index

> **This page is generated.** `cargo xtask deltas` wrote it from commit `dc78185`.
