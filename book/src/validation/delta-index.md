<!-- GENERATED by `cargo xtask deltas` from commit `3ba70c3-dirty`. Do not edit by hand: the next run overwrites it. -->

# Delta marker index

> **This page is generated.** `cargo xtask deltas` wrote it from commit `3ba70c3-dirty`.
